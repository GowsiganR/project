...
public class ProductController
{
			...
			@RequestParam("categoryId") int catid,@RequestParam("supplierId") int supid,@RequestParam("pimage") MultipartFile pimage,Model m)
	{
        ...
        String path="C:/Users/gowsigan/eclipse-workspace4/efrontend/src/main/webapp/resources/images/";
	...
	public String deleteProduct(@PathVariable("productId") int productId,Model m)
	{
		...
		String path="C:/Users/Acer/eclipse-workspace new/ShoppingFrontend/src/main/webapp/resources/images/";
		path=path+String.valueOf(product.getProductId())+".jpg";
	    File image=new File(path);
		image.delete();
